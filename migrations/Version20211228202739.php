 ...
 */
final class Version20211228202739 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE confiscation CHANGE pvNumber pvNumber CHAR(255) DEFAULT NULL');
        $this->addSql('ALTER TABLE material DROP FOREIGN KEY FK_7CBE75954CAC55E2');
        $this->addSql('ALTER TABLE material ADD ready_id INT DEFAULT NULL, CHANGE confiscation_id confiscation_id INT NOT NULL, CHANGE imeiNumber imeiNumber CHAR(255) DEFAULT NULL, CHANGE state state ENUM(\'READY\',\'STOCK\',\'DESTROY\',\'BEINGDESTROY\'), CHANGE status status ENUM(\'UNLOCK\',\'TOBLOCK\',\'UNUSABLE\')');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE confiscation CHANGE pvNumber pvNumber CHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('ALTER TABLE material DROP FOREIGN KEY FK_7CBE75954CAC55E2');
        $this->addSql('DROP INDEX IDX_7CBE759572F4D480 ON material');
        $this->addSql('ALTER TABLE material DROP ready_id, CHANGE confiscation_id confiscation_id INT DEFAULT NULL, CHANGE imeiNumber imeiNumber CHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE state state VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE status status VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT NULL COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('ALTER TABLE material ADD CONSTRAINT FK_7CBE75954CAC55E2 FOREIGN KEY (confiscation_id) REFERENCES confiscation (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
    }
}
